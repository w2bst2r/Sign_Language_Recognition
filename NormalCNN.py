...
def compileModel():
    ...
    model.compile(optimizer= 'sgd', loss= 'categorical_crossentropy',
                  metrics=['accuracy'])\
                  # plotting the model
    #plot_model(model, to_file="CNN_model_new.png", show_shapes=True, show_layer_names=True)
    #model.summary()
#%%       
def trainModel():
...
batch_size = BATCH_SIZE
train_dir =r'C:\Users\Karim El Guermai\Desktop\PROGRAMMING\FinalProject_Last\gestures _splitten\train'
validate_dir =r'C:\Users\Karim El Guermai\Desktop\PROGRAMMING\FinalProject_Last\gestures _splitten\validate'
model = None
